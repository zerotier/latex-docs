...
Next ZeroTier will ask for a network identifier from the user. When this is given the host machine will ask a random root server for the identity of the network controller for that network, as well as a path to contact it through.
